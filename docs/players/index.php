...
<html lang="en">
  <head>
    ...
    <title>AncokPlayer New Iframe Embed Manager</title>    
...
<html lang="en">
    ...
    <span>Add New Movies</span>
                            ...
                            <li>
                                <a class="waves-effect" data-toggle="modal" data-target="#modalForm3">
                                    <i class="mdi mdi-view-dashboard"></i><span class="badge badge-pill badge-success float-right">4</span>
                                    <span>Sample Support Url</span>
                                </a>
                            </li>
                ...
                <div class="page-content">
                        ...
                        <div class="modal-dialog modal-dialog-centered">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                   <textarea class="form-control" rows="5" autofocus="autofocus" onclick="this.select()">&lt;iframe src="<?php echo $domain_name;?>/play.php?id=<?php echo $hashit;?>" frameborder="0" width="100%" height="100%" allowfullscreen="allowfullscreen"&gt; &lt;/iframe&gt;</textarea>
                                </div>
					...
					<div class="modal fade" id="modal_delete<?php echo $fetch['ancokembed_id']?>" aria-hidden="true">
                        <div class="modal-dialog modal-dialog-centered">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h4 class="modal-title">Remove Data Movies!</h4>
                                </div>
                                <div class="modal-body">
                                    <center><p>Are you sure want to remove this data?</p></center>
                                </div>
                                <div class="modal-footer">
                                    <button type="button" class="btn btn-primary btn-sm" data-dismiss="modal">No</button>
                                    <a type="button" class="btn btn-danger btn-sm" href="delete.php?id=<?php echo $fetch['ancokembed_id']?>">Yes</a>
                                </div>
                            </div>
                        </div>
                    </div>  
						...
						<div class="modal-dialog">
							<div class="modal-content">
								<form method="POST" action="update.php">
									<div class="modal-header">
										<h3 class="text-center modal-title">Edit Movies Data</h3>
									</div>	
									<div class="modal-body">										
										<div class="col-md-12">
										<div class="row">
										<div class="col-md-6">										
											<div class="form-group">
												...
												<input class="form-control" type="text" value="<?php echo $fetch['moviestitle']?>" name="moviestitle" required/>
												<input type="hidden" value="<?php echo $fetch['ancokembed_id']?>" name="ancokembed_id"/>
											</div>
											<div class="form-group">
												<label>New Support Url</label>
												<input class="form-control" type="text" value="<?php echo $fetch['gdrivelink']?>" name="gdrivelink" required/>
											</div>											
										</div> 
										<div class="col-md-6">
											<div class="form-group">
												<label>New Embed Link 1</label> 
												<input class="form-control" type="text" value="<?php echo $fetch['embed1']?>" name="embed1" required/>
											</div>
											<div class="form-group">
										...
										<div class="col-md-6">
											...
											<div class="form-group">
												<button class="btn btn-success form-control" type="submit" name="update">Update Data</button>
											</div>
											</div> <!--end row -->
        ...
        <div class="modal-content">
            ...
            <div class="col-md-12">			              
				...
				<div class="form-group">
					...
					<input class="form-control" type="text" placeholder="enter your movie title here" name="moviestitle" required/>
				</div>
				<div class="form-group">
				...
				<div class="col-md-6">
				<div class="form-group">
					<label><span style="color:red">Embed link 1</span></label> 
					<input class="form-control" type="url" placeholder="https://domain.com/embed-bqstfizku2j4.html" name="embed1" required/>
				</div>
				<div class="form-group">
					<label><span style="color:red">Embed link 2</span></label> 
					<input class="form-control" type="url" placeholder="https://domain.com/embed-bqstfizku2j4.html" name="embed2"/>
				</div>
				</div>
				<div class="col-md-6">
				<div class="form-group">
					<label><span style="color:red">Embed link 3</span></label> 
					<input class="form-control" type="url" placeholder="https://domain.com/embed-bqstfizku2j4.html" name="embed3"/>
				</div>
				<div class="form-group">
					<label><span style="color:red">Embed link 4</span></label> 
				...
				<div class="form-group">
				<button class="btn btn-success form-control" type="submit" name="save">Add to Database</button>	
				</div>
...
<div class="modal fade" id="modalForm3" role="dialog">
    <div class="modal-dialog">
        <div class="modal-content">
            <!-- Modal Header -->
            <div class="modal-header">             
                <h4 class="modal-title" id="myModalLabel">Sample Link</h4>
            </div>
            <!-- Modal Body -->
            <div class="modal-body">  
            <div class="col-md-12">			              
                <p><b>SUPPORT LINK:</b><br>
                  1. Google Drive <span style="color:red">Has view Limit!</span><br>
                  2. Google Photos <span style="color:red">Has view Limit!</span><br>
                  3. Youtube<br>
                  4. Mp4 <br>
                  5. M3U8<br>
                  6. Facebook<br>
                  7. Vimeo<br>
                  8. More Coming Soon<br> </p>  
               <p><b>EMBED LINK:</b><br>
                  <b>Support All external Embed link</b><br>
                  ex: <br>
                  1. https://files.im/embed-bqstfizku2j4.html<br>
                  2. https://fembed.com/v/xdk7li546m2gje-<br>
                  3. https://www.mp4upload.com/wbyessi8dehi.html<br>
                  4. Etc</p>  
               <p><b>ADS LINK:</b><br>
                  <b>Support Ad Vast and PopUp link</b><br>
                  <span style="color:red">PopUp</span> <br>
                 https://cadslimz.com/4e/de/4b/xxxxxxxxxxxxxxxxxxxx.js <br>
                 <span style="color:red">AdVast</span><br>
                  https://pubads.g.doubleclick.net/gampad/ads?sz=640x480&iu=/124319096/blablabla...<br>
                  </p>                   
		</div>
            </div>           
        </div>
